...
export const metadata = {
  title: 'Terms of Service — CricRoots',
};
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="space-y-6 text-sm text-ink-secondary leading-relaxed [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-ink [&_h2]:mt-8 [&_h2]:mb-2 [&_p]:mb-3">
        <p>
          These Terms of Service ("Terms") govern your use of CricRoots (the "Service"), a cricket club,
          tournament, and community application. By creating an account or using the Service, you agree
          to these Terms.
        </p>

        <section>
          <h2>1. Who can use CricRoots</h2>
          <p>
            You must be at least 13 years old to create an account. If you are between 13 and 17, you may
            only use CricRoots with the consent and involvement of a parent or guardian, who is responsible
        ...
        <section>
          <h2>2. What CricRoots is for</h2>
          <p>
            CricRoots provides live ball-by-ball scoring, tournament and team management, player statistics
        ...
        <section>
          ...
          <p>
            CricRoots's match prediction feature is a free-to-play points and leaderboard game. It involves
        ...
        <section>
          ...
          <p>
            ...
            submit remain yours, but by submitting them you give CricRoots a license to store, display, and
        ...
        <section>
          <h2>6. Marketplace</h2>
          <p>
            The marketplace connects buyers and sellers directly. CricRoots is not a party to the sale
        ...
        <section>
          ...
          <p>
            Don't use CricRoots to harass others, submit fraudulent match data, attempt to access accounts
        ...
        <section>
          <h2>8. Disclaimers</h2>
          <p>
            CricRoots is provided "as is." Statistics, win-probability estimates, tactical insights, and
        ...
        <section>
          ...
          <p>
            To the extent permitted by law, CricRoots and its operators aren't liable for indirect,
        ...
        <section>
          ...
          <p>
            ...
            "Last updated" date; continued use of CricRoots after a change means you accept the update.
          </p>
        </section>
